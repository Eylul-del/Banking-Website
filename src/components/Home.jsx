...
import mainSubImg from 'public/images/icon/icon.png';
import monthIncomeCard from 'public/images/icon/Icon Container.png';
import mainTransactionCard from 'public/images/img/Container (1).png';
import indiaIcon from 'public/images/icon/indiaIcon.png';
import USDIcon from 'public/images/icon/USDIcon.png';
import AbstractDesign from 'public/images/img/Abstract Design (1).png';
import currency from 'public/images/img/currency.png';
import IconContainer3 from 'public/images/icon/Icon Container (3).png'; 
import IconContainer4 from 'public/images/icon/Icon Container (4).png'; 
import IconContainer5 from 'public/images/icon/Icon Container (5).png'; 
import IconContainer6 from 'public/images/icon/Icon Container (6).png';
import IconContainer7 from 'public/images/icon/Icon Container (7).png';
import IconContainer8 from 'public/images/icon/Icon Container (8).png';
import IconContainer9 from 'public/images/icon/Icon Container (9).png';
import IconContainer10 from 'public/images/icon/Icon Container (10).png';
